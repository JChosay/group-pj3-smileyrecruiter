...
export const searchJobs = async (title, location) => {
  return await fetch(`https://api.adzuna.com/v1/api/jobs/us/search/1?app_id=0a7ada16&app_key=d5fa615b8c01ac683eaceb5645376f7e&results_per_page=100&what=${title}&location0=us&location1=${location}`);
};
